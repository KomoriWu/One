...
public class Find1Fragment extends MvpBaseFragment<FindPresenter> implements FindContract.View, OnItemClickListener {
    private static final String TAG = Find1Fragment.class.getSimpleName();
...
//        getFragmentComponent().inject(this);
    ...
    public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (mParentView == null) {
            mParentView = inflater.inflate(R.layout.fragment1_find, container, false);
        }
        return mParentView;
    }
